...
import { val } from "../assets/icons/social-media/behance";
import "../index.css";
    ...
    >
      <section id="bg-overlay">
        <section className="container">
          <section style={{ padding: "8px 0px 0px 8px" }}>
          ...
          >
            <section>
              <div id="card-body">
                <section
                  className="row"
                  style={{ padding: "60px 0px", margin: "0px" }}
                >
                  <div className="col-lg-12 d-none d-sm-block">
                    <section className="row" style={{ marginBottom: "20px" }}>
                      <section
                        id="profile-img"
                        className="col-3"
                        style={{
                      ...
                      >
                        <img
                          ...
                          style={{
                            ...
                            borderRadius: "100%",
                            boxShadow:
                              "0px 0px 5px 0px #000 , 0px 0px 0px 2px #000",
                          }}
                        />
                        <section
                          style={{ margin: "25px 0px", justifyContent: "center" }}
                        >
                          <p
                            style={{
                              fontSize: "12px",
                          ...
                          >
                            Hi, my name is Ian Paul and I'm a senior software
                          ...
                          <ul>
                            {socialMediaIcons.map((icons, index) => {
                              return (
                                <li
                                  key={index}
                                  className="col social-media cus"
                                >
                                  <img
                                    src={icons.path}
                                    height="16"
                        ...
                        <section style={{ padding: "10px 0px 5px 0px" }}>
                          {/* <p
                          style={{
                            fontSize: "12px",
                            color: "#324e63",
                      ...
                      <section id="profile-data" className="col-9">
                        <section
                          className="row"
                        ...
                        >
                          ...
                          >
                            I'm a software engineer and a part-time freelancer
                            building mobile and web applications. It is a long
                          ...
                          >
                            <div
                              ...
                              className="col-6 button shadow-lg"
                              style={{
                                cursor: "pointer",
                                color: "white",
                                letterSpacing: "0px",
                    ...
                    <section style={{ padding: "50px 10px 0px 10px" }}>
                      ...
                      >
                        ...
                        experience? Check out my online resume and project
                        portfolio.
                      </p>
                    </section>
                  </div>
